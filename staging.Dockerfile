...
ENV OTEL_RESOURCE_ATTRIBUTES="service.namespace=telegram-budget,deployment.environment=staging,service.instance.id=telegram-budget@ubuntu-0,service.version=staging-latest"
